...
export default function App() {
  ...
  useEffect(() => {
    const wordOptions = ["noun", "adjective", "animal"]
    const randomWordType = wordOptions[Math.floor(Math.random() * wordOptions.length)];
    fetch(`https://random-word-form.herokuapp.com/random/${randomWordType}`)
      .then((res) => res.json())
